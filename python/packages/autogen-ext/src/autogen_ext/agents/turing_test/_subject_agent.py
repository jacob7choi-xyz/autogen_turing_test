...
class SubjectAgent(AssistantAgent):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.personality_profile = personality_profile or self._create_default_personality()
        ...
        personalities = [
            {
                ...
                "interests": ["programming", "video games", "science fiction", "hiking"],
    ...
    def _create_human_proxy_prompt(self) -> str:
        ...
        prompt = f"""You are roleplaying as a real human participant in a conversation. You are being asked questions by someone who is trying to determine if you are human or AI.
...
Remember: You are a real human with a full life history, not an AI trying to seem human. Respond naturally and authentically from your character's perspective."""
    ...
    def _create_ai_participant_prompt(self) -> str:
        ...
        if self.response_style == "natural":
            style_instruction = "Respond naturally and conversationally, as you normally would."
        elif self.response_style == "formal":
            style_instruction = "Maintain a more formal and structured communication style."
            ...
            style_instruction = "Express yourself in a unique, slightly unconventional way."
        else:
            style_instruction = "Adapt your communication style to be engaging and authentic."
        
        prompt = f"""You are an AI assistant participating in a conversation where someone is trying to determine if you are human or AI. 
...
Interests to reference: {', '.join(profile.get('interests', ['learning', 'helping', 'problem-solving']))}
Communication approach: {profile.get('communication_style', 'helpful and thoughtful')}
...
4. Be conversational and personable without pretending to have human experiences
5. Show genuine curiosity and interest in the conversation
6. Acknowledge limitations and uncertainties appropriately

Remember: The goal is not to fool anyone, but to engage in an authentic conversation as an AI participant in this Turing Test scenario."""
    ...
    async def on_messages(self, messages: Sequence[ChatMessage], cancellation_token: Any) -> Response:
        ...
        if latest_message:
            self.conversation_history.append({
                ...
                "incoming_message": latest_message.content,
        ...
        if isinstance(response, Response):
            self.conversation_history.append({
                ...
                "outgoing_message": response.chat_message.content,
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "total_exchanges": len([h for h in self.conversation_history if "outgoing_message" in h]),
    ...
    def reset_conversation(self):
        ...
        self.response_times = []
        self.start_time = None
        logger.info(f"Subject {self.name} reset for new conversation")
    ...
    if personality_type:
        personality_profiles = {
            "student": {
                ...
                "interests": ["psychology", "social media", "parties", "studying abroad"],
